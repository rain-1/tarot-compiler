(define (make-let-form table body)
 (vector 'let-form table body))
(define (let-form? l) (and (vector? l) (= 3 (vector-length l)) (eq? (vector-ref l 0) 'let-form)))
(define (let-form-table l) (vector-ref l 1))
(define (let-form-body l) (vector-ref l 2))
